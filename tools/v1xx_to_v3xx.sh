#!/bin/bash
backup="/etc/v2ray/guyezi_v2ray_backup.txt"
...
cat >/etc/v2ray/guyezi_v2ray_backup.conf <<-EOF
# -----------------------------------
# 警告...请不要修改或删除这个文件...谢谢
# 警告...请不要修改或删除这个文件...谢谢
# 警告...请不要修改或删除这个文件...谢谢
...
#---- Socks 用户名 -----
socks_username=guyezi

#---- Socks 密码 -----
socks_userpass=guyezi.com
...
if [[ -f /usr/local/bin/v2ray ]]; then
	cp -f /etc/v2ray/guyezi/v2ray/v2ray.sh /usr/local/sbin/v2ray
